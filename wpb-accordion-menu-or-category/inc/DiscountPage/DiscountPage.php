...
class WpBean_AccordionMenu_DiscountPage
{
		...
		if ( ! get_user_meta( $user_id, 'wpbean_accordion_menu_pro_discount_dismissed' ) && 'wpb-accordions_page_wpbean-discount' !== $screen->base ) {
			...
			<div class="wpb-plugin-discount-page-header notice updated is-dismissible">
				...
				<div>
					...
					Use this discount code: <b>BF2024</b>. <a href="<?php echo esc_url( $discount_url ); ?>">More Details</a></p>
	...
	public function discount_admin_notice_dismissed() {
		...
		//delete_user_meta( $user_id, 'wpbean_accordion_menu_pro_discount_dismissed' );
